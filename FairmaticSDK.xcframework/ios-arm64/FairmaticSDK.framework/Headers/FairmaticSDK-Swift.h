...
/// <ul>
///   <li>
///     See: <code>Fairmatic/startManualDrive(_:completionHandler:)</code>
///   </li>
/// </ul>
...
/// background should set this value to <code>DriveDetectionMode/autoOFF</code>. With this, the application needs to call <code>Fairmatic/startManualDrive(_:completionHandler:)</code> method to record drives. In case the application wants to enable auto drive detection only for a fixed duration (like when the driver is on-duty), use method <code>Fairmatic/setDriveDetectionMode(_:completionHandler:)</code>
...
/// <code>Fairmatic/startManualDrive(_:completionHandler:)</code> to explicitly start recording a drive.
...
/// application has to explicitly invoke the <code>Fairmatic/startManualDrive(_:completionHandler:)</code> method.
...
/// <ul>
///   <li>
///     <code>Fairmatic/startDriveWithPeriod1(completionHandler:)</code>
///   </li>
///   <li>
///     <code>Fairmatic/startDrive(withPeriod2:completionHandler:)</code>
///   </li>
///   <li>
///     <code>Fairmatic/startDrive(withPeriod3:completionHandler:)</code>
///   </li>
///   <li>
...
///
- (nonnull instancetype)initWithName:(NSString * _Nullable)name email:(NSString * _Nullable)email phoneNumber:(NSString * _Nullable)phoneNumber OBJC_DESIGNATED_INITIALIZER;
...
/// Keys for various properties returned by the <code>DriverAttributes/asJson()</code>  method of the <code>DriverAttributes</code>
/// <h2>See Also</h2>
/// <ul>
///   <li>
///     <code>DriverAttributes/asDictionary()</code>
///   </li>
/// </ul>
SWIFT_CLASS_NAMED("DriverAttributesKeys")
@interface FairmaticDriverAttributesKeys : NSObject
/// Key for driver name returned by <code>DriverAttributes/asJson()</code> method.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull driverAttributesKeyName;)
+ (NSString * _Nonnull)driverAttributesKeyName SWIFT_WARN_UNUSED_RESULT;
/// Key for driver email returned by <code>DriverAttributes/asJson()</code> method
...
/// Key for driver phone returned by <code>DriverAttributes/asJson()</code> method
...
/// Additional data in the <code>eventType</code> is <code>EventType/overSpeeding</code>, will be nil otherwise.
...
///     it may get torndown. In all such cases please check <code>Fairmatic/isSDKSetup</code> in the completion handler to confirm if SDK is setup or not.
///   </li>
///   <li>
///     If <code>Configuration/driverId</code> or <code>Configuration/sdkKey</code> is changed while
///     doing multiple setups, it will be the same as calling <code>Fairmatic/teardown(completionHandler:)</code> followed by calling <code>Fairmatic/setup(with:delegate:completionHandler:)</code> with the
///     new parameters.
///   </li>
/// </ul>
...
/// Calling this if Fairmatic is not setup is a no-op. See <code>setup(with:delegate:completionHandler:)</code> for further details.
...
/// <code>setup(with:delegate:completionHandler:)</code> method, and the enclosing application should avoid synchronizing the two methods independently. Calling this
...
/// is a no-op. Calling <code>startManualDrive(_:completionHandler:)</code> with a different trackingId: with implicitly call <code>stopManualDrive(_:)</code> before starting a new drive.
...
/// Refer to <code>FairmaticError</code> for more details on the errors.
///
+ (void)startDriveWithPeriod1WithCompletionHandler:(void (^ _Nullable)(BOOL, NSError * _Nullable))completionHandler;
...
/// This block has no return value and two arguments:
/// isSuccess, A boolean that suggests successful completion of the call
/// the error, A valid error <code>FairmaticError</code> is returned in case of a failure.
/// Possible error codes returned: <code>FairmaticError/notSetup</code>, <code>FairmaticError/insurancePeriodSame</code>,
/// <code>FairmaticError/invalidTrackingId</code>.
/// Refer to <code>FairmaticError</code> for more details on the errors.
///
...
///   </li>
///   <li>
///     <code>Fairmatic/setup(with:delegate:completionHandler:)</code>
///   </li>
/// </ul>
...
/// This error may be returned from <code>Fairmatic/startDriveWithPeriod1(completionHandler:)</code>, <code>Fairmatic/startDrive(withPeriod2:completionHandler:)</code>,
/// <code>Fairmatic/startDrive(withPeriod3:completionHandler:)</code>.
...
/// Refer: <code>Fairmatic/startDriveWithPeriod1(completionHandler:)</code>
  FairmaticInsurancePeriodPeriod1 = 1,
/// Drives undertaken with insurance period 2 will have this value.
/// Refer: <code>Fairmatic/startDrive(withPeriod2:completionHandler:)</code>
  FairmaticInsurancePeriodPeriod2 = 2,
/// Drives undertaken with insurance period 3 will have this value.
/// Refer: <code>Fairmatic/startDrive(withPeriod3:completionHandler:)</code>
...
/// Initialize the beacon with a <code>CLBeacon</code> object.
